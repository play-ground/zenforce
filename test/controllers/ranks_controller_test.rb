...
class RanksControllerTest < ActionController::TestCase
  ...
  test "should create rank" do
    assert_difference('Rank.count') do
      post :create, rank: { logo: @rank.logo, min_points: @rank.min_points, name: @rank.name, sort_order: @rank.sort_order }
    end
  ...
  test "should update rank" do
    patch :update, id: @rank, rank: { logo: @rank.logo, min_points: @rank.min_points, name: @rank.name, sort_order: @rank.sort_order }
    assert_redirected_to rank_path(assigns(:rank))
  end
